...
class ProverbDifficultyConfig:
    ...
    DB_HOST: str = os.getenv("DB_HOST", "localhost1")
    DB_PORT: int = int(os.getenv("DB_PORT", "33061"))
    DB_USER: str = os.getenv("DB_USER", "root1")
    DB_PASSWORD: str = os.getenv("DB_PASSWORD", "root12341")  # 데이터베이스 비밀번호
    DB_NAME: str = os.getenv("DB_NAME", "proverb_game1")  # 속담 게임 전용 DB
